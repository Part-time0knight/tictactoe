...
if (!Obj_tick_main.alarm[1] && !Obj_tick_main.tick)
{
	...
	{
		turn++;
		var shablon = irandom(1), cell_to_move = irandom(3);
	...
	else if (turn == 1 && !vector_metod)
	{
		turn++;
		if (line == 1)
		{
			if (!Obj_tick_main.state[0][0]
				&& !Obj_tick_main.state[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1]
				&& !Obj_tick_main.state[0][Obj_tick_main.field_size_h - 1]
				&& !Obj_tick_main.state[Obj_tick_main.field_size_w - 1][0])
			{
		...
		{
			if (Obj_tick_main.state[0][0] == 1)
				if (!Obj_tick_main.state[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1])
				{
					Obj_tick_main.field[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1].make_turn = true;
					vector_metod = true;
				}
			...
			else if (Obj_tick_main.state[0][Obj_tick_main.field_size_h - 1] == 1)
				if (!Obj_tick_main.state[Obj_tick_main.field_size_w - 1][0])
				{
					Obj_tick_main.field[Obj_tick_main.field_size_w - 1][0].make_turn = true;
					vector_metod = true;
				}
			...
			else if (Obj_tick_main.state[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1] == 1)
				if (!Obj_tick_main.state[0][0])
				{
					Obj_tick_main.field[0][0].make_turn = true;
					vector_metod = true;
			...
			else if (Obj_tick_main.state[Obj_tick_main.field_size_w - 1][0] == 1)
				if (!Obj_tick_main.state[0][Obj_tick_main.field_size_h - 1])
				{
					Obj_tick_main.field[0][Obj_tick_main.field_size_h - 1].make_turn = true;
					vector_metod = true;
				}
	...
	else if (turn == 2 && !vector_metod)
	{
		turn++;
		max_vector_my = Scr_search_max_vector(Obj_tick_main.state, Obj_tick_main.field_size_w,  Obj_tick_main.field_size_h, 1, Obj_tick_main.vector_size);
		...
		else
		{
			if (!Obj_tick_main.state[0][0])
				...
				Obj_tick_main.field[Obj_tick_main.field_size_w - 1][0].make_turn = true;
			else if (!Obj_tick_main.state[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1])
				Obj_tick_main.field[Obj_tick_main.field_size_w - 1][Obj_tick_main.field_size_h - 1].make_turn = true;
			vector_metod = true;
		}
	}
	...
	{
		max_vector_my = Scr_search_max_vector(Obj_tick_main.state, Obj_tick_main.field_size_w,  Obj_tick_main.field_size_h, 1, Obj_tick_main.vector_size);
		max_vector_enemy = Scr_search_max_vector(Obj_tick_main.state, Obj_tick_main.field_size_w,  Obj_tick_main.field_size_h, 2, Obj_tick_main.vector_size);
		if (max_vector_my && max_vector_my.size == Obj_tick_main.vector_size - 1)
		{
			var turn_x, turn_y;
			for (var i = 0; i < max_vector_my.size_free; i++)
